...
public class WelcomeConfiguration {
    ...
    public static class Builder {
        ...
        private int bottomLayoutRes = com.amaze.fileutilities.home_page.welcome_helper.WelcomeConfiguration.BottomLayout.STANDARD.resId;
        ...
        private void initDefaultBackgroundColor(android.content.Context context) {
            ...
            if (defaultBackgroundColor == standardBackgroundColor && android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP)
         ...
         */
        public com.amaze.fileutilities.home_page.welcome_helper.WelcomeConfiguration build() {
            return new com.amaze.fileutilities.home_page.welcome_helper.WelcomeConfiguration(this);
        }
         ...
         */
        public com.amaze.fileutilities.home_page.welcome_helper.WelcomeConfiguration.Builder swipeToDismiss(boolean swipeToDismiss) {
         ...
         * @return this Builder object to allow method calls to be chained
         */
        public com.amaze.fileutilities.home_page.welcome_helper.WelcomeConfiguration.Builder canSkip(boolean canSkip) {
         ...
         * @return this Builder object to allow method calls to be chained
         */
        public com.amaze.fileutilities.home_page.welcome_helper.WelcomeConfiguration.Builder backButtonSkips(boolean backButtonSkips) {
         ...
         * @return this Builder object to allow method calls to be chained
         */
        public com.amaze.fileutilities.home_page.welcome_helper.WelcomeConfiguration.Builder backButtonNavigatesPages(boolean navigatesPages) {
         ...
         * @return this Builder object to allow method calls to be chained
         */
        public com.amaze.fileutilities.home_page.welcome_helper.WelcomeConfiguration.Builder animateButtons(boolean animateButtons) {
         ...
         * @return this Builder object to allow method calls to be chained
         */
        public com.amaze.fileutilities.home_page.welcome_helper.WelcomeConfiguration.Builder useCustomDoneButton(boolean useCustomDoneButton) {
         ...
         * @return this Builder object to allow method calls to be chained
         */
        public com.amaze.fileutilities.home_page.welcome_helper.WelcomeConfiguration.Builder defaultBackgroundColor(@ColorRes int resId) {
