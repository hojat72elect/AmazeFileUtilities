...
public class FullscreenParallaxPage extends WelcomePage<com.amaze.fileutilities.home_page.welcome_helper.FullscreenParallaxPage> {
     ...
     */
    public com.amaze.fileutilities.home_page.welcome_helper.FullscreenParallaxPage firstParallaxFactor(float factor) {
     ...
     * @return This FullscreenParallaxPage object to allow method calls to be chained
     */
    public com.amaze.fileutilities.home_page.welcome_helper.FullscreenParallaxPage lastParallaxFactor(float factor) {
     ...
     * @return This FullscreenParallaxPage object to allow method calls to be chained
     */
    public com.amaze.fileutilities.home_page.welcome_helper.FullscreenParallaxPage recursive(boolean recursive) {
